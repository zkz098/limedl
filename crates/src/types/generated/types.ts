...
export type BtRuntimeStatus = {
  ...
  updatedAtMs: bigint;
  seedCount?: bigint | null;
  leechCount?: bigint | null;
};
...
export type BtSettings = {
  ...
  globalDownloadRateLimit: bigint;
  globalUploadRateLimit: bigint;
  /**
