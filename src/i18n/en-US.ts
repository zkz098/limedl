const enUS = {
  translation: {
    ...
    setupWizard: {
      ...
      stepCdn: "CDN Acceleration",
      stepRpc: "Aria2 RPC",
      stepPerformance: "Download Performance",
      stepDirectory: "Download Directory",
      stepAppearance: "Appearance",
      stepAutostart: "Auto-start",
      stepSummary: "Review",
      nextButton: "Next",
      backButton: "Back",
      ...
      performanceDescription: "Choose thread allocation and chunking strategy to optimize downloads.",
