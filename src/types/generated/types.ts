...
export type AppSettings = { appearance: AppearanceSettings, proxy: ProxySettings, scheduler: SchedulerSettings, download: DownloadDefaultsSettings, bt: BtSettings, logging: LogSettings, aria2Rpc: Aria2RpcSettings, cdnAcceleration: CdnAccelerationSettings, urlRewrite: UrlRewriteSettings, globalSpeedLimitBps: number, speedLimitSchedule: Array<SpeedLimitSlot>, notifications: NotificationSettings, ioBaseline: IoBaselineSettings, autostart: boolean, setupCompleted: boolean, lastSetupStep: number | null, 
/**
