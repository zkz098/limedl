const enUS = {
  translation: {
    ...
    settings: {
      ...
      autoStartHint: "Start flareget automatically when you log in. The app will start minimized to the system tray.",
      ...
      aboutChannelDowngradeWarning: "Cannot downgrade automatically. Your current version is newer than the latest on this channel. Please install manually.",
      ioBaseline: {
