...
// buildSelections preserves existing per-index selections across file updates.
watch(
  () => props.files,
  (files) => {
...
<template>
  ...
  >
    ...
    <!-- File list -->
    <div v-else class="bt-file-picker__body" data-testid="bt-file-picker-body">
      ...
      <ul class="bt-file-picker__list" data-testid="bt-file-list">
        <li
          v-for="file in files"
          :key="file.index"
