const enUS = {
  translation: {
    ...
    settings: {
      ...
      aria2RpcRecommendDesc: "Use the Aria2 Explorer browser extension to automatically send browser downloads to the Aria2 engine. Supports HTTP, BT and magnet links, with a built-in AriaNg management panel.",
      aria2RpcRecommendNote: "Edge users can install via the Chrome Web Store (Edge supports Chrome extensions).",
      logging: "Logging",
      ...
      aboutResetConfirm: "Are you sure you want to restore all settings to defaults? This cannot be undone.",
