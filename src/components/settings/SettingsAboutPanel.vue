...
function buildDefaultSettings() {
  return {
    ...
    scheduler: {
      ...
      automatic: { maxParallelThreads: 16, maxThreadsPerTask: 8, minThreadsPerTask: 0, adaptiveProfile: "balanced" as const },
    ...
    bt: {
      ...
      upnpEnabled: false, enableNatpmp: true, enableIpv6: true,
      enablePex: true, enableLsd: true, enableUtp: true,
      ...
      preallocateMode: "none" as const, encryptionMode: "enabled" as const,
      maxDownloads: 3, maxSeeds: 5, maxTorrents: 100, activeLimit: 500,
    },
    logging: { enabled: true, level: "info" as const, filePath: "", retentionCount: null, retentionDays: null },
    ...
    ioBaseline: {
      bufferLimitMb: 1024, gameModeBufferMb: 128,
      maxParallelHdd: 4, gameModeMaxParallel: 1, hddBufferEnabled: true,
      diskTypeOverrides: {},
    },
    downloadLimits: null,
    autostart: false,
