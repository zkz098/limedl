const enUS = {
  translation: {
    ...
    composer: {
      ...
      expectedChecksumPlaceholder: "Leave blank to auto-detect or enter 64-hex SHA-256",
      probeChecksum: "Probe SHA-256",
      probingChecksum: "Probing...",
      checksumDetected: "Auto-detected",
    ...
    settings: {
      ...
      autoDetectSha256: "Auto-detect SHA-256",
      autoDetectSha256Label: "Auto-probe .sha256 and SHA256SUMS files",
      autoDetectSha256Hint:
        "Automatically probe for matching .sha256 or parent SHA256SUMS files when downloading HTTP links, and verify after completion.",
