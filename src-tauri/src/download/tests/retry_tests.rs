...
//! `tauri::async_runtime::spawn`.  There is no injection point for test doubles.
...
use super::super::aimd::AimdState;
use super::super::error::DownloadError;
use super::super::manager::DownloadCore;
use super::super::manifest::Manifest;
use super::super::types::{ChecksumMode, DownloadSnapshot, DownloadState, TaskKind, ThreadMode};
use super::backoff_delay;
use super::request_with_retry;
...
fn make_managed() -> Arc<super::super::manager::ManagedDownload> {
    Arc::new(super::super::manager::ManagedDownload {
...
// - The background task is spawned via `tauri::async_runtime::spawn`, which
